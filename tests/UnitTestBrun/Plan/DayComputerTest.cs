...
namespace UnitTestBrun.Plan
{
    ...
    public class DayComputerTest
    {
        ...
        public void TestNumber()
        {
            ...
            DateTimeOffset? next = dayComputer.Compute(start.AddSeconds(1), tcs);
            Console.WriteLine(next);
            Assert.AreEqual(DateTime.Parse("2021-4-3 0:1:0"), next);
            DateTimeOffset? next2 = dayComputer.Compute(next.Value.AddSeconds(1), tcs);
            Console.WriteLine(next2);
            Assert.AreEqual(DateTime.Parse("2021-4-3 0:1:1"), next2);
            DateTimeOffset? next3 = dayComputer.Compute(DateTime.Parse("2021-4-18 4:1:1"), tcs);
        ...
        {
            {
                ...
                DateTimeOffset? next2 = dayComputer.Compute(DateTime.Parse("2021-3-1 0:0:0"), tcs);
                Console.WriteLine(next2);
                Assert.AreEqual(DateTime.Parse("2021-3-28 0:0:0"), next2);

                DateTimeOffset? next3 = dayComputer.Compute(DateTime.Parse("2021-4-29 0:0:0"), tcs);
                Console.WriteLine(next3);
        ...
        {
            {
                ...
                DateTimeOffset? next2 = dayComputer.Compute(DateTime.Parse("2021-2-28 0:0:0"), tcs);
                Console.WriteLine(next2);
                Assert.AreEqual(DateTime.Parse("2021-3-5 0:0:0"), next2);

                DateTimeOffset? next3 = dayComputer.Compute(DateTime.Parse("2021-3-6 0:0:0"), tcs);
                Console.WriteLine(next3);
            ...
            }
            {
                ...
                DateTimeOffset? next4 = dayComputer.Compute(DateTime.Parse("2021-3-30 0:0:0"), tcs);
                Console.WriteLine(next4);
