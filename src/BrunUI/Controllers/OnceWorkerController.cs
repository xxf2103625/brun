...
namespace BrunUI.Controllers
{
    ...
    public class OnceWorkerController : BaseBrunController
    {
        ...
        public OnceWorkerController(IOnceWorkerService onceWorkerService, IWorkerService workerService)
        {
        ...
        public TableResult QueryList(int current, int pageSize)
        {
            ...
            //var onceWorkers = workerService.GetWorkerInfos(current, pageSize).Result.Item1;
            //int index = 0;
