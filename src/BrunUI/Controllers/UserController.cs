...
namespace BrunUI.Controllers
{
    ...
    public class UserController : BaseBrunController
    {
        ...
        public object CurrentUser()
        {
            ...
            return new { Success = true, Data = new { Name = User?.Identity?.Name, Roles = new List<string>() { "admin" }, Avatar = "https://gw.alipayobjects.com/zos/antfincdn/XAosXuNZyF/BiazfanxmamNRoxxVxka.png" } };
        }
        [HttpPost]
