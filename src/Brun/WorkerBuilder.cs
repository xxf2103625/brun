...
//            return builder;
//        }
//        public static WorkerBuilder CreateOnceWorker<TBackRun>(string key, string name, string tag, WorkerConfig config = null, ConcurrentDictionary<string, string> data = null) where TBackRun : IBackRun, new()
//        {
//            WorkerBuilder workerBuilder = new WorkerBuilder()
//            {
//                config = config == null ? WorkerServer.Instance.ServerConfig.DefaultConfig : config
//            };
//            workerBuilder.SetKey(key);
//            workerBuilder.SetName(name);
//            workerBuilder.SetTag(tag);
